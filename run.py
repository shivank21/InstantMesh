...
def main():
    ...
    print(f'GPU {rank}: Loading custom white-background unet ...')
    ...
    print(f'GPU {rank}: Loading reconstruction model ...')
    ...
    input_files = [input_files[i] for i in range(len(input_files)) if i % world_size == rank]
